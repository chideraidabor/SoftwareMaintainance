 ...
 * RoomFour - Is the fourth room for the map
 * Change Log
 * /////////////////////////////////////////////////////////////////////////////
 * Date       Contributer    Change
 * 03Apr18    Kevin          Initial RoomFour Created - initially is almost clone
 *                              of LevelOneRoomOne
 */
...
public class RoomFour extends Arena{
    private static RoomFour room = new RoomFour();
    
    private enum Dir{
        TOP, BOTTOM, LEFT, RIGHT
    }
    
    public static RoomFour getInstance(){
        return room;
    }
    ...
    protected void init(){
        ...
        doorList[2] = RoomFive.getInstance();
        doorList[3] = RoomThree.getInstance();
