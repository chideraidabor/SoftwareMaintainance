 ...
 * RoomSeven - Is the seventh room for the map
 * Change Log
 * /////////////////////////////////////////////////////////////////////////////
 * Date       Contributer    Change
 * 03Apr18    Kevin          Initial RoomSeven Created - initially is almost clone
 *                              of LevelOneRoomOne
 */
...
public class RoomSeven extends Arena{
    private static RoomSeven room = new RoomSeven();
    
    private enum Dir{
        TOP, BOTTOM, LEFT, RIGHT
    }
    
    public static RoomSeven getInstance(){
        return room;
    }
    ...
    protected void init(){
        ...
        doorList[1] = RoomEight.getInstance();
        doorList[2] = NoRoom.getInstance();
        doorList[3] = RoomSix.getInstance();
