...
public class Player2 extends Actor {
    ...
    private static Player2 player = new Player2();
    ...
    private Player2(){
        actorImg = new Image("/images/farmerPixel.png", getScreenWidth() * 0.1, getScreenHeight() * 0.1, true, false);
   ...
   public static void updateXpBar(double amount){
    ...
    protected void setStats(){
        ...
        exp = minExp;
        username = "";
        job = "Farmer"; // TODO: To be changed when we add more class
        speed = 10.0;
    }
